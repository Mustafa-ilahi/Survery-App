      ...
      <View style={styles.btnTop}>
        <TouchableOpacity>
          <View style={styles.signInView}>
            ...
            <Text style={styles.signInText}>Use phone / email / username</Text>
          </View>
        </TouchableOpacity>
      </View>
      <View style={styles.btnBottom}>
        <TouchableOpacity>
          <View style={styles.signInView}>
            ...
            <Text style={styles.facebookText}>Continue With Facebook Login</Text>
          </View>
        </TouchableOpacity>
      </View>
      <View style={styles.btnBottom}>
      ...
      <View style={styles.btnBottom}>
        <TouchableOpacity>
          <View style={styles.signInView}>
            ...
            <Text style={styles.googleText}>Use phone / email / username</Text>
          </View>
        </TouchableOpacity>
      </View>
      </View>
